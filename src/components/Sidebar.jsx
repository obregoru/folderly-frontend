  ...
  return (
    <aside className="bg-white border-r border-border p-4 md:p-4 overflow-y-auto flex flex-col gap-4 md:gap-5 h-full">
      ...
      <div>
        ...
        <div className="mb-2"><label className="text-[11px] text-muted block mb-0.5">Audience notes <HelpTip text="Which audiences this business typically serves overall (not per-video). AI reads this as context when a clip is ambiguous. E.g. 'Mostly teen birthdays and girls' night, occasional date night and family. Rarely kids parties.' Different from the per-clip audience override in the Suggest modal." /></label>
          <textarea rows={3} className="field-input resize-none" value={s.audience_notes || ''} onChange={e => save('audience_notes', e.target.value)} placeholder={"Which audiences this business typically serves.\n\nExample:\nMostly teen birthdays and girls' night. Occasional date night and adult creative outings. Rarely kids parties."} /></div>
